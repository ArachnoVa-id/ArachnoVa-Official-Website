  ...
  return (
    <section className="w-full min-h-screen relative  flex flex-row justify-center items-center bg-white-MainPage">
      <div className="flex flex-col">
        ...
        <div className="text-neutral-e w-[56vw] text-center text-[1vw] font-SourceSansProSemibold ">
        ...
        <div className="relative">
          <div className="w-[50vw] h-[50vh] bg-transparent border-[0.2vw] border-[#E2E8F0] rounded-md flex flex-col overflow-y-scroll no-scrollbar  ">
            <img
              alt=""
          ...
          <div className="absolute w-[14vw] h-[40vh] bg-black -bottom-[8vh] right-[0] flex flex-col overflow-y-scroll no-scrollbar  ">
            <img
              alt=""
