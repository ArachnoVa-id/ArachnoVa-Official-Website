  ...
  return (
    <>
      <section className="relative w-full lg:min-h-[33.125vw] min-h-[158.14vw] flex flex-col justify-center items-center bg-white-MainPage lg:gap-y-[2.083vw] gap-y-[5.581vw]">
        ...
        <button
          className={
            "flex flex-row justify-center items-center lg:w-[9.792vw] w-[47.209vw] aspect-[204/40] gap-x-[0.26vw] lg:aspect-[188/48] bg-transparent lg:rounded-[0.417vw] rounded-[1.86vw] hover:bg-[#5AB0BB]/20 hover:scale-[102%] transition-all duration-700 ease-in-out " +
            styles.ButtonShadow
          }
        >
