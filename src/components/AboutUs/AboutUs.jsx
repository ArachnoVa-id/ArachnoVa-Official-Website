...
const AboutUs = () => {
  ...
  return (
    <section className="relative w-full min-h-[104.167vw] flex flex-col justify-around items-center bg-white-MainPage">
      <img
      ...
      <div className="relative w-fit h-fit">
        <img
          ...
          className="absolute -left-[19.083vw] -bottom-[10.917vw] w-[45.552vw] aspect-[433/235] z-0"
          alt="blur"
        />
        <img
          src="/image/AboutUs/blur-right.png"
          className="absolute -right-[11.208vw] -top-[15vw] w-[28.24vw] aspect-[225/321] z-0"
        />
        <div
          className="relative w-[58.75vw] aspect-[1128/414] justify-center items-center flex flex-col rounded-[0.833vw] border-[0.104vw] border-white z-10"
      ...
      <div
        className="flex flex-row justify-between items-center w-[40.625vw] aspect-[702/111] p-[2.083vw] bg-white rounded-[1.042vw] border-[0.156vw] border-[#E2E8F0] mb-[2.604vw]"
      ...
      <div className="w-[66.667vw] flex flex-row justify-between items-center mb-[10vw]">
        <ContentBox
          Title="Vision"
